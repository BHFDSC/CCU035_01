...
-- MAGIC vaccine_data = '.ccu035_01_vaccine_status_'
-- MAGIC 
-- MAGIC #Other data inputs
-- MAGIC skinny_QA_inclusion_table = '.ccu035_01_inf_included_patients' 
...
#select VACCINE_PRODUCT_CODE from .ccu035_01_vaccine_status_
...
drop table if exists .ccu035_01_vac_vaccine_status

-- COMMAND ----------

-- MAGIC %python
-- MAGIC 
-- MAGIC #create_table(table_name=final_table, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu035_01_vaccine_status_final_temp")
...
select * from .ccu035_01_vac_vaccine_status
...
/*with cte_interval as (SELECT NHS_NUMBER_DEID, VACCINE_DOSE, VACCINATION_DATE, VACCINE_PRODUCT FROM .ccu035_01_vacc_vaccine_status_final
)
*/
...
from 
   --global_temp.ccu035_01_vacc_vaccine_status_final_temp as tbl1 
     .ccu035_01_vac_vaccine_status as tbl1
LEFT JOIN 
     --global_temp.ccu035_01_vacc_vaccine_status_final_temp as tbl2
     .ccu035_01_vac_vaccine_status as tbl2
...
create table .ccu035_01_vaccine_status_number as
...
/*create table .ccu035_01_vac_vaccine_status_additional_analysis as
...
--drop table if exists .ccu035_01_vacc_vaccine_status_final
