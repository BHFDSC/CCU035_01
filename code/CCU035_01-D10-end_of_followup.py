...
vaccine = spark.table(f'.ccu035_01vaccine_all')
...
# MAGIC %sql
# MAGIC drop table  .ccu035_01_start_and_end_date

# COMMAND ----------

# MAGIC %sql
# MAGIC create table .ccu035_01_start_and_end_date as
# MAGIC select *
...
# MAGIC %sql
# MAGIC select * from .ccu035_01_start_and_end_date
...
# MAGIC %sql
# MAGIC create table .ccu035_01_second_infection as
