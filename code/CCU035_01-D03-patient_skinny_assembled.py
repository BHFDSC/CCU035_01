...
# MAGIC %md # CCU035_01-D04-patient_skinny_assembled
# MAGIC 
# MAGIC **Description** Making a single record for each patient in primary and secondary care. This uses the output from *CCU035_01_D01_patient_skinny_unassembled*
# MAGIC  
# MAGIC **Author(s)** Updated by Rochelle Knight for CCU035_01 from work by Sam Hollings and Jenny Cooper for CCU002_02 
# MAGIC 
# MAGIC **Description** Populates the table `.ccu035_01_inf_skinny_patient` with the following for **all patients (alive/dead)** on **1st Jan 2020**:
# MAGIC - SEX
# MAGIC - RAW_ETHNICITY
...
# MAGIC `CCU035_01-D03-patient_skinny_unassembled` This is simply a list of all the records for each patient from all the datasets.
# MAGIC  
# MAGIC **Project(s)** CCU035_01
# MAGIC  
# MAGIC **Reviewer(s)** 
# MAGIC  
# MAGIC **Date last updated** 2021-06-20
# MAGIC  
# MAGIC **Date last reviewed** UNREVIEWED
# MAGIC  
# MAGIC **Date last run** 2021-06-02
# MAGIC  
# MAGIC **Data input** `global_temp.patient_skinny_unassembled` 
# MAGIC 
# MAGIC `.ccu035_01_gdppr_`
# MAGIC 
# MAGIC **Data output** `.ccu035_01_inf_skinny_patient`
# MAGIC 
...
# MAGIC %run Workspaces//CCU035_01/CCU035_01-functions/wrang000_functions

# COMMAND ----------

# MAGIC %run "/Workspaces//CCU035_01/CCU035_01-D15-master_notebook_parameters"
...
dbutils.notebook.run("/Workspaces//CCU035_01/CCU035_01-D03-patient_skinny_unassembled",3000)
...
spark.sql(f"""DROP TABLE IF EXISTS {collab_database_name}.{project_prefix}{skinny_table_name}""")

# COMMAND ----------

create_table(project_prefix + skinny_table_name, select_sql_script=f"SELECT * FROM global_temp.{project_prefix}patient_skinny_record_age") 
