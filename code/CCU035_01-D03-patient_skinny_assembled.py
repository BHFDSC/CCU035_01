...
# MAGIC 
# MAGIC **Description** Populates the table `dars_nic_391419_j3w9t_collab.ccu035_01_inf_skinny_patient` with the following for **all patients (alive/dead)** on **1st Jan 2020**:
# MAGIC - SEX
# MAGIC - RAW_ETHNICITY
...
# MAGIC 
# MAGIC **Data output** `dars_nic_391419_j3w9t_collab.ccu035_01_inf_skinny_patient`
# MAGIC 
...
dbutils.notebook.run("/Workspaces/dars_nic_391419_j3w9t_collab/CCU035_01/CCU035_01-D03-patient_skinny_unassembled",3000)
