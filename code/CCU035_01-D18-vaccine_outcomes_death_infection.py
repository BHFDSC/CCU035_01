...
# MAGIC deaths_data = '.ccu035_01_deaths_'
# MAGIC 
# MAGIC index_dates='.ccu035_01_start_and_end_date'
# MAGIC project_prefix = 'ccu035_01_'
# MAGIC collab_database_name = ''
...
tmp=spark.table(f'global_temp.{project_prefix}infection_death_outcomes_first_position')\
  ...
  .where((f.col('covid19_confirmed_date') < f.col('REG_DATE_OF_DEATH_FORMATTED')))
...
#%sql
#drop table  .ccu035_01_infection_death_outcomes_first_position

# COMMAND ----------

create_table('ccu035_01_infection_death_outcomes_first_position_all' , select_sql_script=f"SELECT * FROM global_temp.ccu035_01_infection_death_outcomes_first_position") 
...
create_table('ccu035_01_infection_death_outcomes_all' , select_sql_script=f"SELECT * FROM global_temp.ccu035_01_infection_death_outcomes") 
