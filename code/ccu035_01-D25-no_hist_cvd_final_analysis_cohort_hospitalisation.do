...
log using "${log_files}ccu035_01_no_hist_cvd_final_analysis_cohort2_hospitalisation.doc", text replace
...
file open covid_di using "cox_cluster_estimates_ccu035_01_no_hist_cvd_hospitalisation.csv", write replace 
...
lincom pred1 + pred2
	...
	gen twenty=r(p)
	file open desc using "cox_cluster_estimates_ccu035_01_no_hist_cvd_hospitalisation.csv",  write append
