...
# MAGIC hes_data = '.ccu035_01_hes_apc_all_years'
...
#%sql
#drop table  .ccu035_01_infection_hesapcoutcomes_first_diagnosis 
...
# MAGIC 
# MAGIC CREATE TABLE .CCU035_01_infection_hesapcoutcomes_first_diagnosis_all  AS
...
#FROM .CCU035_01_infection_hesapcoutcomes_first_diagnosis
#group by name
#order by count desc 
...
CREATE TABLE .CCU035_01_infection_hesapcoutcomes_  AS
...
SELECT count(Distinct NHS_NUMBER_DEID) as count, name
--FROM global_temp.CCU035_01_infection_hesapcoutcomes_first_diagnosis 
FROM .CCU035_01_infection_hesapcoutcomes
group by name
order by count desc 
"""
...
#%sql
#select * from .CCU035_01_infection_hesapcoutcomes
