...
# MAGIC %md # CCU035_01-D03-patient_skinny_unassembled
# MAGIC 
# MAGIC **Description** Gather together the records for each patient in primary and secondary care before they are assembled into a skinny record for CCU035_01. The output of this is a global temp View which is then used by **CCU035_01-D02-patient_skinny_record**
# MAGIC  
# MAGIC **Author(s)** Updated by Rochelle Knight for CCU035_01 from notebook by Sam Hollings and Jenny Cooper 
# MAGIC 
# MAGIC **Reviewer(s)** 
# MAGIC 
# MAGIC **Date last updated** 2021-06-29
# MAGIC 
# MAGIC **Date last reviewed**
# MAGIC 
# MAGIC **Data last run** 2021-06-29
# MAGIC 
# MAGIC **Data input** 
# MAGIC 
...
# MAGIC 
# MAGIC 
# MAGIC **Data output** `global_temp.ccu035_01_patient_skinny_unassembled`
# MAGIC 
...
FROM (
      ...
      FROM (
          ...
          --LEFT JOIN .deaths_ death on all_patients.NHS_NUMBER_DEID = death.DEC_CONF_NHS_NUMBER_CLEAN_DEID
    ) """)
