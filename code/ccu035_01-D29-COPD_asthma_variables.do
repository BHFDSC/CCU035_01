...
clear all
odbc load, exec ("SELECT * FROM .ccu035_02_out_covariates_flags") dsn("databricks")
rename *, lower
save "D:\Users\h.whittaker\Documents\single_covariates.dta", replace

clear all
odbc load, exec ("SELECT * FROM .ccu035_02_out_covariates_washout") dsn("databricks")
rename *, lower
...
odbc load, exec ("SELECT * FROM .ccu035_01_ics_for_gina") dsn("databricks")
