...
# MAGIC  
# MAGIC **Description** Creates a LSOA to region lookup table. This code was originally from `/DATA_CURATION/wrang901_geography` by Sam Hollings.
# MAGIC 
...
# MAGIC %sql
# MAGIC drop table if exists .ccu035_01_lsoa_region_lookup

# COMMAND ----------

# MAGIC %sql
# MAGIC create table .CCU035_01_lsoa_region_lookup as
# MAGIC SELECT * FROM global_temp.ccu035_01_lsoa_region_lookup

# COMMAND ----------

# MAGIC %sql
# MAGIC ALTER TABLE .ccu035_01_lsoa_region_lookup OWNER TO 

# COMMAND ----------

# MAGIC %sql
# MAGIC SELECT COUNT (lsoa_code) FROM  .ccu035_01_lsoa_region_lookup 
