...
log using "${log_files}ccu035_01_final_analysis_cohort2_ethinicity.doc", text replace
...
file open covid_di using "cox_cluster_estimates_ccu035_01_ethinicity.csv", write replace 
...
ren ethnic_cat5 white
	...
	file open desc using "cox_cluster_estimates_ccu035_01_ethinicity.csv",  write append
