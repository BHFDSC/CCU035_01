...
# MAGIC %run /Workspaces//CCU035_01/CCU035_01-functions/CCU035_01_COVID_trajectory_helper_functions_from_CCU013
...
# MAGIC --OPTIMIZE .ccu035_01_tmp_sgss
...
# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC --OPTIMIZE .ccu035_01_tmp_gdppr
...
# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC --OPTIMIZE .ccu035_01_tmp_deaths
...
#                  INNER JOIN .ccu0_total_population ON tab1.PERSON_ID_DEID = ccu0_total_population.person_id_deid''')
...
# MAGIC %sql
# MAGIC --OPTIMIZE .ccu035_01_tmp_apc
...
# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC --OPTIMIZE .ccu035_01_tmp_cc
...
# %sql
# SELECT max(date) FROM .ccu0_tmp_pillar2

# COMMAND ----------

# %sql -- create_table makes all tables as deltatables by default optimize
# OPTIMIZE .ccu0_tmp_pillar2
...
# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC --OPTIMIZE .ccu035_01_tmp_chess
...
# MAGIC %sql -- create_table makes all tables as deltatables by default optimize
# MAGIC -- ! Takes ~ 24 mins
# MAGIC --OPTIMIZE .ccu035_01_tmp_sus
