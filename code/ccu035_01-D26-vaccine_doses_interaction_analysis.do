...
log using "${log_files}ccu035_01_vaccine_doses_all_cvd_resp_all_interaction analysis.doc", text replace
...
gen unvaccinated_all_cvd=unvaccinated*resp_all
gen dose_1_all_cvd=dose_1*resp_all
gen dose_2_all_cvd=dose_2*resp_all
gen booster_all_cvd=booster*resp_all
...
stcox resp_all dose_1 dose_2 booster, cluster(nhs_number_deid)

stcox resp_all age_at_cohort_start female current_smoker ex_smoker obese_bmi surgery_lastyr_hes hypertension diabetes cancer liver_disease dementia ckd depression hist_cvd cvd_meds east_midlands east_of_england north_east north_west south_east south_west west_midlands yorkshire_and_the_humber deci_imd1 deci_imd2 deci_imd3 deci_imd4 deci_imd5 deci_imd6 deci_imd7 deci_imd8 deci_imd9 asian black mixed other dose_1 dose_2 booster, cluster(nhs_number_deid)


stcox resp_all dose_1 dose_2 booster dose_1_all_cvd dose_2_all_cvd booster_all_cvd, cluster(nhs_number_deid)

stcox resp_all age_at_cohort_start female current_smoker ex_smoker obese_bmi surgery_lastyr_hes hypertension diabetes cancer liver_disease dementia ckd depression hist_cvd cvd_meds east_midlands east_of_england north_east north_west south_east south_west west_midlands yorkshire_and_the_humber deci_imd1 deci_imd2 deci_imd3 deci_imd4 deci_imd5 deci_imd6 deci_imd7 deci_imd8 deci_imd9 asian black mixed other dose_1 dose_2 booster dose_1_all_cvd dose_2_all_cvd booster_all_cvd, cluster(nhs_number_deid)


lincom dose_1 + dose_1_all_cvd, hr

lincom dose_2 + dose_2_all_cvd, hr

lincom booster + booster_all_cvd, hr


lincom resp_all + dose_1_all_cvd, hr

lincom resp_all + dose_2_all_cvd, hr

lincom resp_all + booster_all_cvd, hr
