...
# MAGIC %sql
# MAGIC drop table  .ccu035_01_infection_hesapcoutcomes_first_diagnosis 
...
# MAGIC 
# MAGIC CREATE TABLE .CCU035_01_infection_hesapcoutcomes_first_diagnosis  AS
...
# MAGIC ---created truncated caliber codes with dot missing and using all outcomes
# MAGIC 
# MAGIC CREATE TABLE .CCU035_01_infection_hesapcoutcomes  AS
...
# MAGIC %sql
# MAGIC select * from .CCU035_01_infection_hesapcoutcomes
